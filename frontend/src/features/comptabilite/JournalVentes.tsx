...
export default function JournalVentes() {
  ...
  return (
    <div className="p-6">
      ...
      <p className="text-sm text-muted-foreground mb-6">Cédantes (comptes 411xxxxx)</p>
        ...
        <table className="w-full">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="px-4 py-3 text-left text-xs font-medium text-muted-foreground uppercase">Cédante</th>
