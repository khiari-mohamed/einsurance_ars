...
import { ArrowLeft, Edit2, Trash2, Plus, Mail, Phone, Building2, MapPin, CreditCard, FileText, FileCheck, Shield, Globe } from 'lucide-react';
...
export default function CedanteDetail() {
  ...
  return (
    <div className="p-4 lg:p-6">
      ...
      {/* Bank Account Modal - Add if you have this component */}
       {isBankModalOpen && (
        <CedanteBankModal
          cedanteId={id!}
