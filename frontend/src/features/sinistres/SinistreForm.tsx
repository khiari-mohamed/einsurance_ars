  ...
  return (
    <div className="p-8">
      <div className="flex items-center gap-4 mb-6">
        <button onClick={() => navigate('/sinistres')} className="text-muted-foreground hover:text-foreground">
          <ArrowLeft size={24} />
        </button>
        <h1 className="font-display text-3xl font-semibold text-foreground">Nouveau Sinistre</h1>
      </div>

      <form onSubmit={handleSubmit} className="bg-card rounded-[var(--radius)] border border-border p-6 space-y-6">
        <div className="grid grid-cols-2 gap-6">
          <div>
            <label className="block text-sm font-medium text-foreground mb-2">Affaire (placée) *</label>
            <select
              required
          ...
          <div>
            <label className="block text-sm font-medium text-foreground mb-2">N° Police Cédante</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-sm font-medium text-foreground mb-2">Date Survenance *</label>
            <input
              required
              type="date"
          ...
          <div>
            <label className="block text-sm font-medium text-foreground mb-2">Période de Couverture</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-sm font-medium text-foreground mb-2">Règlement Exercice N</label>
            <input
          ...
          <div>
            <label className="block text-sm font-medium text-foreground mb-2">Cumul Règlements Antérieurs</label>
            <input
              type="number" step="0.001"
          ...
          <div>
            <label className="block text-sm font-medium text-foreground mb-2">Réserves</label>
            <input
              type="number" step="0.001"
          ...
          <div>
            <label className="block text-sm font-medium text-foreground mb-2">Part Réassureurs</label>
            <input
              type="number" step="0.001"
          ...
          <div>
            <label className="block text-sm font-medium text-foreground mb-2">Cause</label>
            <input
              type="text"
        ...
        <div className="flex justify-end gap-4">
          <button type="button" onClick={() => navigate('/sinistres')} className="px-6 py-2 border border-border rounded-lg hover:bg-muted">
            Annuler
          </button>
          <button
            type="submit"
